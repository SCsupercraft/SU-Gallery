      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            <br />
            <br />
            Mods marked with a warning symbol means that the extension is not
            made for that mod, but it <em>should</em> still work.
          </DialogDescription>
        </DialogHeader>
    ...
    <>
      <p className="pl-5 pr-5">
        {authors.map((credit) => {
          ...
          const flag2 = authors[authors.length - 1].name == credit.name;
          const flag3 = !flag2;
      ...
      <p className="p-5 pt-0">
        {originalAuthors.map((credit) => {
          ...
          const flag2 =
            originalAuthors[originalAuthors.length - 1].name == credit.name;
          const flag3 = !flag2;
